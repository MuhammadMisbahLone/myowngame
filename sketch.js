...
function preload() {
    ...
    bridgeImg = loadImage("sprites/bridge.png");
    bridgesignImg = loadImage("sprites/bridgesign.png");
    noparkingImg = loadImage("sprites/noparking.png");
    noparkingsignImg = loadImage("sprites/noparkingsign.jpg");
    noentryImg = loadImage("sprites/noentry.png");
    noentrysignImg = loadImage("sprites/noentrysign.png");
    uturnImg = loadImage("sprites/uturn.png");
    uturnsignImg = loadImage("sprites/uturnsign.png");
    nouturnImg = loadImage("sprites/nouturn.png");
    nouturnsignImg = loadImage("sprites/nouturnsign.jpg");
    nohornImg = loadImage("sprites/nohorn.png");
    nohornsignImg = loadImage("sprites/nohornsign.jpg");
    lastImg = loadImage("sprites/message.jpg");
    startImg = loadImage("sprites/start.jpg");
    greetingImg = loadImage("sprites/hello.jpg");
} 
